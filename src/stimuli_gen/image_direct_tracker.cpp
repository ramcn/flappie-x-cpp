...
int main (int argc, char *argv[])
{
    ...
    int randomArrayind_1 = rand() % 2;
    int trkcbbuffassignment = buffassign[randomArrayind_1];
    int cbdet1buffassignment = buffassign[randomArrayind_1];
...
#define PI 3.14159265
    ...
    Mat copyimg_d1(height, width, CV_8U, Scalar(0));
    finalimg_data = (unsigned char*)copyimg_d1.data;
    imwrite("newfinalimg.pgm", copyimg_d1);
